...
public class SitDown extends AppCompatActivity {
    ...
    private final static String Main_Action = "SitDown";
    private final static String Pocket = "Pocket";
    private final static String Hand = "Hand";
    private final static String Use = "Use";

    private final static int LABEL_POCKET = 31;
    private final static int LABEL_HAND = 32;
    private final static int LABEL_USE = 33;
